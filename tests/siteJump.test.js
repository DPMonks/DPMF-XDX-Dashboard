...
import { SITE_JUMP_IDS, pageTravelPercent, readJumpHash, sectionAtLockLine, siteJumpItems, trailChromeOffset } from "../src/siteJump.js";
...
test("travel percent and lock line follow the page", () => {
  ...
  assert.equal(trailChromeOffset({ headerH: 80, barH: 52, padTop: 8 }), 140);
  const lookup = (id) => ({
