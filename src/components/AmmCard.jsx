      ...
      .then((live) => {
        ...
        setLiveByKey((current) => {
          ...
          if (
            ...
            Number(stamped.reserve_asset ?? stamped.reserve_xdx) ===
              Number(baseline.reserve_asset ?? baseline.reserve_xdx) &&
  ...
  function applyTradeThenLive(detail) {
    ...
    setLiveByKey((current) => {
      ...
      for (const row of nextTargets) {
        ...
        beforeByKey[key] = {
          reserve_xdx: shown.reserve_asset ?? shown.reserve_xdx,
          reserve_asset: shown.reserve_asset ?? shown.reserve_xdx,
